...
describe('SettingService', () => {
  ...
  afterEach(async () => {
    ...
    try {
      ...
      await settingService.deleteMany({
        name: {
          $in: [settingName1, settingName2, settingName3, settingName4],
        },
      });
    } catch (err: any) {
      console.error(err);
  ...
  describe('findAll', () => {
    it('get all setting', async () => {
      ...
      jest.spyOn(settingService, 'findAll').mockReturnValueOnce(result as any);
  ...
  describe('getTotal', () => {
    it('should return a number of total data', async () => {
      ...
      jest.spyOn(settingService, 'getTotal').mockReturnValueOnce(result as any);
  ...
  describe('findOneById', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(settingService, 'findOneById')
  ...
  describe('findOneByName', () => {
    it('should be return a setting entity', async () => {
      ...
      jest
        .spyOn(settingService, 'findOneByName')
        .mockReturnValueOnce(result as any);
  ...
  describe('create', () => {
    it('should be create a new setting, number', async () => {
      ...
      jest.spyOn(settingService, 'create').mockReturnValueOnce(result as any);
  ...
  describe('updateValue', () => {
    it('should be update a value, number', async () => {
      ...
      jest
        .spyOn(settingService, 'updateValue')
        .mockReturnValueOnce(result as any);
  ...
  describe('deleteOneById', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(settingService, 'deleteOneById')
        .mockReturnValueOnce(result as any);
  ...
  describe('deleteOne', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(settingService, 'deleteOne')
        .mockReturnValueOnce(result as any);
  ...
  describe('getMaintenance', () => {
    it('should be return a setting', async () => {
      ...
      jest
        .spyOn(settingService, 'getMaintenance')
        .mockReturnValueOnce(result as any);
  ...
  describe('getMobileNumberCountryCodeAllowed', () => {
    it('should be return a setting', async () => {
      ...
      jest
        .spyOn(settingService, 'getMobileNumberCountryCodeAllowed')
        .mockReturnValueOnce(result as any);
  ...
  describe('getPasswordAttempt', () => {
    it('should be return a setting', async () => {
      ...
      jest
        .spyOn(settingService, 'getPasswordAttempt')
        .mockReturnValueOnce(result as any);
  ...
  describe('getMaxPasswordAttempt', () => {
    it('should be return a setting', async () => {
      ...
      jest
        .spyOn(settingService, 'getMaxPasswordAttempt')
        .mockReturnValueOnce(result as any);
  ...
  describe('deleteMany', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(settingService, 'deleteMany')
        .mockReturnValueOnce(result as any);
  ...
  describe('getValue', () => {
    it('should be return a number value', async () => {
      ...
      const result: number = await settingService.getValue<number>(setting1);

      jest.spyOn(settingService, 'getValue').mockReturnValueOnce(result as any);
    ...
    it('should be return a string value', async () => {
      ...
      const result: string = await settingService.getValue<string>(setting2);
    ...
    it('should be return a boolean value true', async () => {
      ...
      const result: boolean = await settingService.getValue<boolean>(setting3);
