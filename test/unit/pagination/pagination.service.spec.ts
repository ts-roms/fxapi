...
describe('PaginationService', () => {
  ...
  describe('offset', () => {
    it('should be offset for page 1', async () => {
      ...
      jest
        .spyOn(paginationService, 'offset')
  ...
  describe('offsetWithoutMax', () => {
    it('should be offset for page 1', async () => {
      ...
      jest
        .spyOn(paginationService, 'offsetWithoutMax')
        .mockReturnValueOnce(result as any);
  ...
  describe('totalPageWithoutMax', () => {
    it('should be return a total page base on perPage and total data', async () => {
      const result: number = paginationService.totalPageWithoutMax(100, 10);

      jest
        .spyOn(paginationService, 'totalPageWithoutMax')
        .mockReturnValueOnce(result as any);
    ...
    it('should be return a total page without depends on max page ', async () => {
      const result: number = paginationService.totalPageWithoutMax(10000, 10);
  ...
  describe('page', () => {
    it('should be return page', async () => {
      ...
      jest.spyOn(paginationService, 'page').mockReturnValueOnce(result as any);
    ...
    it('page more than max, should return max page', async () => {
      const result: number = paginationService.page(PAGINATION_MAX_PAGE + 10);
  ...
  describe('perPage', () => {
    it('should be return perPage', async () => {
      ...
      jest
        .spyOn(paginationService, 'perPage')
        .mockReturnValueOnce(result as any);
  ...
  describe('sort', () => {
    it('should be return sort', async () => {
      const result: Record<string, number | string> = paginationService.sort(
        PAGINATION_AVAILABLE_SORT,
        PAGINATION_SORT
      );

      jest.spyOn(paginationService, 'sort').mockReturnValueOnce(result as any);
  ...
  describe('search', () => {
    it('should be return search', async () => {
      const result: Record<string, number | string> = paginationService.search(
        ['name'],
        'test'
      );

      jest
        .spyOn(paginationService, 'search')
        .mockReturnValueOnce(result as any);
  ...
  describe('filterEqual', () => {
    it('should be return a value', async () => {
      ...
      jest
        .spyOn(paginationService, 'filterEqual')
        .mockReturnValueOnce(result as any);
  ...
  describe('filterContain', () => {
    it('should be return a value', async () => {
      ...
      jest
        .spyOn(paginationService, 'filterContain')
        .mockReturnValueOnce(result as any);
  ...
  describe('filterIn', () => {
    it('should be return a value', async () => {
      ...
      jest
        .spyOn(paginationService, 'filterIn')
        .mockReturnValueOnce(result as any);
  ...
  describe('filterDate', () => {
    it('should be return a value', async () => {
      ...
      jest
        .spyOn(paginationService, 'filterDate')
        .mockReturnValueOnce(result as any);
