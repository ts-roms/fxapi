...
describe('HelperNumberService', () => {
  ...
  describe('check', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(helperNumberService, 'check').mockReturnValueOnce(result);
  ...
  describe('create', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(helperNumberService, 'create').mockReturnValueOnce(result);
  ...
  describe('random', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(helperNumberService, 'random').mockReturnValueOnce(result);
  ...
  describe('percent', () => {
    ...
    it('should be success with NaN or Infinite', async () => {
      ...
      jest
        .spyOn(helperNumberService, 'percent')
