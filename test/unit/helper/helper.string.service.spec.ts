...
describe('HelperStringService', () => {
  ...
  describe('checkEmail', () => {
    it('should be success', async () => {
      const result: boolean = helperStringService.checkEmail('111@mail.com');

      jest.spyOn(helperStringService, 'checkEmail').mockReturnValueOnce(result);
  ...
  describe('randomReference', () => {
    ...
    it('should be success with prefix', async () => {
      const result: string = helperStringService.randomReference(10, 'test');
  ...
  describe('random', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(helperStringService, 'random').mockReturnValueOnce(result);
  ...
  describe('censor', () => {
    it('string length 1 should be success', async () => {
      ...
      jest.spyOn(helperStringService, 'censor').mockReturnValueOnce(result);
