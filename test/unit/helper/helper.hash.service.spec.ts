...
describe('HelperHashService', () => {
  ...
  describe('randomSalt', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(helperHashService, 'randomSalt').mockReturnValueOnce(result);
  ...
  describe('bcryptCompare', () => {
    ...
    it('should be failed', async () => {
      const salt = helperHashService.randomSalt(10);
      const hash = helperHashService.bcrypt(data, salt);
      const result: boolean = helperHashService.bcryptCompare('bbbb', hash);
  ...
  describe('sha256Compare', () => {
    ...
    it('should be failed', async () => {
      const hash = helperHashService.sha256(data);
      const result: boolean = helperHashService.sha256Compare('bbbb', hash);
