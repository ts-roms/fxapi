...
describe('HelperFileService', () => {
  ...
  describe('createExcelWorkbook', () => {
    it('should be convert array of object to excel workbook', async () => {
      ...
      jest
        .spyOn(helperFileService, 'createExcelWorkbook')
  ...
  describe('writeExcelToBuffer', () => {
    it('write workbook to buffer', async () => {
      const result: Buffer = helperFileService.writeExcelToBuffer(workbook);

      jest
        .spyOn(helperFileService, 'writeExcelToBuffer')
        .mockReturnValueOnce(result);
  ...
  describe('readExcelFromBuffer', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(helperFileService, 'readExcelFromBuffer')
        .mockReturnValueOnce(result);
