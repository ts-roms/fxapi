...
describe('HelperDateService', () => {
  ...
  describe('calculateAge', () => {
    it('return age in number', async () => {
      ...
      jest.spyOn(helperDateService, 'calculateAge').mockReturnValueOnce(result);
  ...
  describe('checkTimestamp', () => {
    it('number must be a valid timestamp', async () => {
      const result: boolean = helperDateService.checkTimestamp(dateTimestamp);
  ...
  describe('timestamp', () => {
    it('should be create timestamp base on today', async () => {
      ...
      jest.spyOn(helperDateService, 'timestamp').mockReturnValueOnce(result);
  ...
  describe('endOfMonth', () => {
    it('return date end of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'endOfMonth').mockReturnValueOnce(result);
  ...
  describe('startOfMonth', () => {
    it('return date start of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'startOfMonth').mockReturnValueOnce(result);
  ...
  describe('endOfYear', () => {
    it('return date end of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'endOfYear').mockReturnValueOnce(result);
  ...
  describe('startOfYear', () => {
    it('return date start of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'startOfYear').mockReturnValueOnce(result);
  ...
  describe('endOfDay', () => {
    it('return date end of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'endOfDay').mockReturnValueOnce(result);
  ...
  describe('startOfDay', () => {
    it('return date start of current year', async () => {
      ...
      jest.spyOn(helperDateService, 'startOfDay').mockReturnValueOnce(result);
  ...
  describe('extractDate', () => {
    it('should extract a date to dat, month, and year as number', async () => {
      ...
      jest.spyOn(helperDateService, 'extractDate').mockReturnValueOnce(result);
  ...
  describe('roundDown', () => {
    it('should be round down a milis from date', async () => {
      ...
      jest.spyOn(helperDateService, 'roundDown').mockReturnValueOnce(result);
  ...
  describe('getStartAndEndDate', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(helperDateService, 'getStartAndEndDate')
        .mockReturnValueOnce(result);
