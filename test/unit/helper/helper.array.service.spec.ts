...
describe('HelperArrayService', () => {
  ...
  describe('getLeftByLength', () => {
    it('should be return a array by 1 length from left', async () => {
      const result: (number | string)[] = helperArrayService.getLeftByLength<
        number | string
      >(arrays, 1);
  ...
  describe('getRightByLength', () => {
    it('should be return a array by 1 length from right', async () => {
      const result: (number | string)[] = helperArrayService.getRightByLength<
        number | string
      >(arrays, 1);
  ...
  describe('getLast', () => {
    it('should be return a last data of array', async () => {
      ...
      jest.spyOn(helperArrayService, 'getLast').mockReturnValueOnce(result);
  ...
  describe('getFirst', () => {
    it('should be return a first data of array', async () => {
      ...
      jest.spyOn(helperArrayService, 'getFirst').mockReturnValueOnce(result);
  ...
  describe('removeLeftByLength', () => {
    it('should remove array by length from left', async () => {
      const result: (number | string)[] = helperArrayService.removeLeftByLength<
        number | string
      >(arrays, 1);
  ...
  describe('removeRightByLength', () => {
    it('should remove array by length from right', async () => {
      const result: (number | string)[] =
        helperArrayService.removeRightByLength<number | string>(arrays, 1);
  ...
  describe('joinToString', () => {
    it('should join array to string', async () => {
      const result: string = helperArrayService.joinToString<number | string>(
        arrays,
        ','
      );
  ...
  describe('reverse', () => {
    it('array should be reversed', async () => {
      ...
      jest.spyOn(helperArrayService, 'reverse').mockReturnValueOnce(result);
  ...
  describe('unique', () => {
    it('array should be unique', async () => {
      ...
      jest.spyOn(helperArrayService, 'unique').mockReturnValueOnce(result);
  ...
  describe('shuffle', () => {
    it('array should be shuffle', async () => {
      ...
      jest.spyOn(helperArrayService, 'shuffle').mockReturnValueOnce(result);
  ...
  describe('mergeUnique', () => {
    it('array should be merger and unique array', async () => {
      ...
      jest.spyOn(helperArrayService, 'mergeUnique').mockReturnValueOnce(result);
  ...
  describe('filterIncludeByValue', () => {
    it('should be return filtered value', async () => {
      const result: (number | string)[] =
        helperArrayService.filterIncludeByValue<number | string>(arrays, 1);

      jest
        .spyOn(helperArrayService, 'filterIncludeByValue')
        .mockReturnValueOnce(result);
  ...
  describe('filterNotIncludeByValue', () => {
    it('should be return filtered value', async () => {
      const result: (number | string)[] =
        helperArrayService.filterNotIncludeByValue<number | string>(arrays, 1);
  ...
  describe('filterNotIncludeUniqueByArray', () => {
    it('should be return filtered value', async () => {
      const result: (number | string)[] =
        helperArrayService.filterNotIncludeUniqueByArray<number | string>(
          arrays,
          [1]
        );

      jest
        .spyOn(helperArrayService, 'filterNotIncludeUniqueByArray')
        .mockReturnValueOnce(result);
  ...
  describe('filterIncludeUniqueByArray', () => {
    it('should be return filtered value', async () => {
      const result: (number | string)[] =
        helperArrayService.filterIncludeUniqueByArray<number | string>(arrays, [
          1,
        ]);

      jest
        .spyOn(helperArrayService, 'filterIncludeUniqueByArray')
        .mockReturnValueOnce(result);
  ...
  describe('equals', () => {
    it('should be equals', async () => {
      ...
      jest.spyOn(helperArrayService, 'equals').mockReturnValueOnce(result);
  ...
  describe('notEquals', () => {
    it('should be equals', async () => {
      const result: boolean = helperArrayService.notEquals(arrays, [1, 2, 3]);

      jest.spyOn(helperArrayService, 'notEquals').mockReturnValueOnce(result);
  ...
  describe('includes', () => {
    it('value must includes arrays', async () => {
      ...
      jest.spyOn(helperArrayService, 'includes').mockReturnValueOnce(result);
  ...
  describe('chunk', () => {
    it('array chunk to be x value', async () => {
      const result: (number | string)[][] = helperArrayService.chunk(arrays, 2);
