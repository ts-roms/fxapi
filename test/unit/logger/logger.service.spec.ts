...
describe('LoggerService', () => {
  ...
  describe('info', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(loggerService, 'info').mockReturnValueOnce(result as any);
    ...
    it('with complete data', async () => {
      const result: LoggerEntity = await loggerService.info(loggerComplete);
  ...
  describe('debug', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(loggerService, 'debug').mockReturnValueOnce(result as any);
    ...
    it('with complete data', async () => {
      const result: LoggerEntity = await loggerService.debug(loggerComplete);
  ...
  describe('warning', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(loggerService, 'warn').mockReturnValueOnce(result as any);
  ...
  describe('fatal', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(loggerService, 'fatal').mockReturnValueOnce(result as any);
