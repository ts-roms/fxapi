...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    ...
    encryptedPermissionToken = await authService.encryptPermissionToken(user);

    prefixAuthorization = configService.get<string>('auth.prefixAuthorization');
    ...
    payloadEncryption = configService.get<boolean>('auth.payloadEncryption');
  ...
  describe('encryptAccessToken', () => {
    it('should be return a hashed string', async () => {
      ...
      jest
        .spyOn(authService, 'encryptAccessToken')
  ...
  describe('decryptAccessToken', () => {
    it('should be return payload data', async () => {
      const result: Record<string, any> = await authService.decryptAccessToken({
        data: encryptedAccessToken,
      });

      jest
        .spyOn(authService, 'decryptAccessToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('payloadAccessToken', () => {
    it('should given a payload of token', async () => {
      const result: Record<string, any> = await authService.payloadAccessToken(
        accessToken
      );
  ...
  describe('encryptRefreshToken', () => {
    it('should be return a hashed string', async () => {
      ...
      jest
        .spyOn(authService, 'encryptRefreshToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('decryptRefreshToken', () => {
    it('should be return payload data', async () => {
      const result: Record<string, any> = await authService.decryptRefreshToken(
        {
      ...
      jest
        .spyOn(authService, 'decryptRefreshToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('payloadRefreshToken', () => {
    it('should given a payload of token', async () => {
      const result: Record<string, any> = await authService.payloadRefreshToken(
        refreshToken
      );
  ...
  describe('encryptPermissionToken', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(authService, 'encryptPermissionToken')
  ...
  describe('decryptPermissionToken', () => {
    it('should be return payload data', async () => {
      ...
      jest
        .spyOn(authService, 'decryptPermissionToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('createPermissionToken', () => {
    it('should be create refresh token in string, from object', async () => {
      const result: string = await authService.createPermissionToken(user);

      jest
        .spyOn(authService, 'createPermissionToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('validatePermissionToken', () => {
    it('should be verified', async () => {
      ...
      jest
        .spyOn(authService, 'validatePermissionToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('payloadPermissionToken', () => {
    it('should given a payload of token', async () => {
      ...
      jest
        .spyOn(authService, 'payloadPermissionToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('createPayloadPermissionToken', () => {
    it('should be mapped', async () => {
      ...
      jest
        .spyOn(authService, 'createPayloadPermissionToken')
        .mockReturnValueOnce(result as any);
  ...
  describe('createPassword', () => {
    it('should be success', async () => {
      const password = faker.internet.password(20, true, /[A-Za-z0-9]/);
      const result: IAuthPassword = await authService.createPassword(password);
  ...
  describe('getAccessTokenExpirationTime', () => {
    it('should be give number in days for access token expiration', async () => {
      const result: number = await authService.getAccessTokenExpirationTime();
  ...
  describe('getRefreshTokenExpirationTime', () => {
    it('should be give number in days for refresh token expiration', async () => {
      const result: number = await authService.getRefreshTokenExpirationTime();
  ...
  describe('getIssuer', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(authService, 'getIssuer').mockReturnValueOnce(result as any);
  ...
  describe('getAudience', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(authService, 'getAudience').mockReturnValueOnce(result as any);
  ...
  describe('getSubject', () => {
    it('should be success', async () => {
      ...
      jest.spyOn(authService, 'getSubject').mockReturnValueOnce(result as any);
  ...
  describe('getPayloadEncryption', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(authService, 'getPayloadEncryption')
        .mockReturnValueOnce(result as any);
  ...
  describe('getPermissionTokenExpirationTime', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(authService, 'getPermissionTokenExpirationTime')
        .mockReturnValueOnce(result as any);
