...
describe('ApiKeyService', () => {
  ...
  describe('findAll', () => {
    it('should return the array of apikeys', async () => {
      ...
      jest.spyOn(apiKeyService, 'findAll').mockReturnValueOnce(result as any);
  ...
  describe('findOneById', () => {
    it('should return a found apikey', async () => {
      const result: ApiKeyEntity = await apiKeyService.findOneById(apiKey._id);
  ...
  describe('findOne', () => {
    it('should return a found apikey', async () => {
      ...
      jest.spyOn(apiKeyService, 'findOne').mockReturnValueOnce(result as any);
  ...
  describe('findOneByKey', () => {
    it('should return a found apikey', async () => {
      const result: ApiKeyEntity = await apiKeyService.findOneByKey(apiKey.key);
      jest
        .spyOn(apiKeyService, 'findOneByKey')
        .mockReturnValueOnce(result as any);
  ...
  describe('findOneByActiveKey', () => {
    it('should return a found apikey', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'findOneByActiveKey')
        .mockReturnValueOnce(result as any);
    ...
    it('should not return a apikey', async () => {
      ...
      jest.spyOn(apiKeyService, 'findOneByActiveKey').mockReturnValueOnce(null);
  ...
  describe('getTotal', () => {
    it('should return total data of apikeys', async () => {
      ...
      jest.spyOn(apiKeyService, 'getTotal').mockReturnValueOnce(result as any);
  ...
  describe('active', () => {
    it('should make apikey to be active', async () => {
      ...
      jest.spyOn(apiKeyService, 'active').mockReturnValueOnce(result as any);
  ...
  describe('inactive', () => {
    it('should make apikey to be inactive', async () => {
      const result: ApiKeyEntity = await apiKeyService.inactive(apiKey._id);

      jest.spyOn(apiKeyService, 'inactive').mockReturnValueOnce(result as any);
  ...
  describe('create', () => {
    it('should return a new apikeys', async () => {
      ...
      jest.spyOn(apiKeyService, 'create').mockReturnValueOnce(result as any);
  ...
  describe('createRaw', () => {
    it('should return a new apikeys', async () => {
      ...
      jest.spyOn(apiKeyService, 'createRaw').mockReturnValueOnce(result as any);
  ...
  describe('update', () => {
    it('should return a updated apikey', async () => {
      ...
      const result: ApiKeyEntity = await apiKeyService.update(apiKey._id, {
        name: nameUpdate,
        description: faker.random.alphaNumeric(20),
      });
      jest.spyOn(apiKeyService, 'update').mockReturnValueOnce(result as any);
  ...
  describe('updateDate', () => {
    it('should return a updated apikey', async () => {
      const result: ApiKeyEntity = await apiKeyService.updateDate(apiKey._id, {
        startDate,
        endDate,
      });
      jest
        .spyOn(apiKeyService, 'updateDate')
        .mockReturnValueOnce(result as any);
  ...
  describe('reset', () => {
    it('old hashed should be difference with new hashed', async () => {
      ...
      jest.spyOn(apiKeyService, 'reset').mockReturnValueOnce(result as any);
  ...
  describe('deleteOneById', () => {
    it('should be success to delete', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'deleteOneById')
        .mockReturnValueOnce(result as any);
  ...
  describe('deleteOne', () => {
    it('should be success to delete', async () => {
      ...
      jest.spyOn(apiKeyService, 'deleteOne').mockReturnValueOnce(result as any);
  ...
  describe('validateHashApiKey', () => {
    it('should be succeed', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'validateHashApiKey')
        .mockReturnValueOnce(result as any);
  ...
  describe('createKey', () => {
    it('should return a string', async () => {
      ...
      jest.spyOn(apiKeyService, 'createKey').mockReturnValueOnce(result as any);
  ...
  describe('createSecret', () => {
    it('should return a string', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'createSecret')
        .mockReturnValueOnce(result as any);
  ...
  describe('createKey', () => {
    it('should return a hashed string', async () => {
      ...
      const hashed: string = helperHashService.sha256(`${key1}:${secret1}`);
  ...
  describe('deleteMany', () => {
    it('should be succeed', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'deleteMany')
        .mockReturnValueOnce(result as any);
  ...
  describe('inactiveManyByEndDate', () => {
    it('should be succeed', async () => {
      ...
      jest
        .spyOn(apiKeyService, 'inactiveManyByEndDate')
        .mockReturnValueOnce(result as any);
